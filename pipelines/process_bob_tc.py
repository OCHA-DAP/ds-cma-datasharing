...
tidy parquet to ds-cma-datasharing/processed/2022-2025_BoB_TC.parquet.

Source blobs: ds-cma-datasharing/cma_ftp/data_out/2022-2025_BoB_TC/**/*.dat
Output blob:  ds-cma-datasharing/processed/2022-2025_BoB_TC.parquet
...
BLOB_PREFIX = "ds-cma-datasharing/cma_ftp/data_out/2022-2025_BoB_TC"
OUTPUT_BLOB = "ds-cma-datasharing/processed/2022-2025_BoB_TC.parquet"
...
def main():
    ...
    for blob_name in sorted(dat_blobs):
        ...
        df = parse_dat_file(blob_name, content)
        frames.append(df)
